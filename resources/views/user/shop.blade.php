										...
										<div class="col-lg-3 col-md-4 col-sm-6 single-item">
											...
											<div class="product-wrapper mb-40">
												<div class="product-img">
													<a href="/detail/{{$books[$i]->getObjectId()}}">
														<img src="{{$books[$i]->get('images')[0]}}" alt="book" class="primary">
													</a>
												</div>
												<div class="product-details text-center">
													<h4><a href="/detail/{{$books[$i]->getObjectId()}}">{{$books[$i]->get('title')}}</a></h4>
													<div class="product-price">
														<ul>
															<li>{{$books[$i]->get("promotionPrice")}} đ</li>
															<li class="old-price">{{$books[$i]->get("OriginPrice")}} đ</li>
														</ul>
													</div>
												</div>
												<div class="product-link">
													<div class="product-button">
														<a onclick="clientAddToCart('{{$books[$i]->getObjectId()}}')" title="{{__('addToCart')}}">
															<i class="fa fa-shopping-cart"></i>{{__('addToCart')}}
														</a>
													</div>
													<div class="add-to-link">
														<ul>
															<li><a href="/detail/{{$books[$i]->getObjectId()}}" title="Details"><i class="fa fa-external-link"></i></a></li>
														</ul>
													</div>
												</div>
											</div>
